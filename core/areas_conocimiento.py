# Crear archivo de áreas de conocimiento
@"
...
"@ | Out-File -FilePath "core/areas_conocimiento.py" -Encoding UTF8

Write-Host "✅ core/areas_conocimiento.py creado" -ForegroundColor Green